...
enum KeybindingDefaults {
    ...
    static let table: [Command: [KeyBinding]] = [
        ...
        .promoteHeading:      [KeyBinding("[", .command)],
        .demoteHeading:       [KeyBinding("]", .command)],
        .headingToBody:       [KeyBinding("0", [.command, .option])],
        .headingLevel1:       [KeyBinding("1", [.command, .option])],
        .headingLevel2:       [KeyBinding("2", [.command, .option])],
        .headingLevel3:       [KeyBinding("3", [.command, .option])],
        .headingLevel4:       [KeyBinding("4", [.command, .option])],
        .headingLevel5:       [KeyBinding("5", [.command, .option])],
        .headingLevel6:       [KeyBinding("6", [.command, .option])],
        ...
        .taskPanel:           [KeyBinding("3", [.command, .option, .shift])],
        ...
        .goBack:              [KeyBinding("[", [.command, .control])],
        .goForward:           [KeyBinding("]", [.command, .control])],
